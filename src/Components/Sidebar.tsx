...
const Sidebar : FC = () => {
    ...
    return(
        ...
        <div className="flex flex-col bg-gray-700 w-15 ml-2 mt-2 mb-2 rounded-xl shadow-2xl items-center z-50">
                        ...
                        {id : 4, icon : faGear}
                            ...
                            return (
                                <div className="relative flex items-center" key={id}>
                                    {
                                        selectedIcon === id && 
                                        <div className="absolute -left-5 w-1 h-6 bg-white rounded-tr-full rounded-br-full"></div>
                                    }
